(function( $ ) {
    ...
    $.ec.Base.prototype.makeLabel = function( name, color ) {
        return $( "<label class='point-label'></label>" )
            .text( name )
            .css({
                // "text-shadow": "-0   -1px 0   #000000, 0   -1px 0   #000000, -0    1px 0   #000000,0    1px 0   #000000, -1px -0   0   #000000,1px -0   0   #000000,-1px  0   0   #000000,1px  0   0   #000000,-1px -1px 0   #000000,1px -1px 0   #000000,-1px  1px 0   #000000,1px  1px 0   #000000,-1px -1px 0   #000000, 1px -1px 0   #000000,-1px  1px 0   #000000,1px  1px 0   #000000,-1px -1px 0   #000000,1px -1px 0   #000000,-1px  1px 0   #000000,1px  1px 0   #000000,-1px -1px 0   #000000, 1px -1px 0   #000000, -1px  1px 0   #000000,1px  1px 0   #000000",
                "position": "absolute",
                "width": "1em",
                "line-height": "1em",
                "text-align": "center",
    ...
    $.ec.Base.prototype.setLabel = function( label, p ) {
        if( p === null ) {
            ...
            label.css({
                "display": "block",
                "left": xScale * ( p[ 0 ] - this.plotRange.xMin ) - 5 + "px",
                "top": yScale * ( this.plotRange.yMax - p[ 1 ] ) - 15 + "px"
            });
        }
    };
    ...
    $.ec.reals.PointAddition.prototype.getPlotData = function() {
        ...
        if( this.r !== null ) {
            ...
            data.push({
                color: colors.red,
                data: [ this.r ],
                points: { show: true, radius: 2, fillColor: colors.red },
            });
        }
        ...
        data.push({
            color: colors.yellow,
            data: [ this.p, this.q ],
            points: { show: true, radius: 2, fillColor: colors.yellow },
        });
